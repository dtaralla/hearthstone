 ...
 * description AND its implementation. An Action linked to a CardIdentity
 * flyweight is itself a flyweight. When a Card is instanciated from a
 * CardIdentity flyweight, the actions linked to the CardIdentity are also
 * instanciated for this very Card, giving it the context it needs to execute
 * itself. We call this card the <em>source card</em> of the Action.
 *
