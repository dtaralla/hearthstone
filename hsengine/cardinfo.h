 ...
 *
 * Usually, CardInfo objects are created based on information organized as a
 ...
 * classes of CardInfo and returns a CardType. You might wander whether a
 * CardInfo is a CharacterInfo, regardless of it being a HeroInfo or a minion's
...
public:
     ...
     *
     * When you only have a <code>CardInfo*</code> pointer, this factory method
     ...
     * still be wandering whether a CardInfo is a CharacterInfo, regardless of
